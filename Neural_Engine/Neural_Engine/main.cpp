...
int main(int argc, char* argv[])
{
	...
	NN::Math::Algebra::Vector_Arithmetic<current_type> weights = {
		0.15f, 0.20f, 0.25f, 0.30f, 0.40f, 0.45f, 0.50f, 0.55f
	};
	NN::Math::Algebra::Vector_Arithmetic<current_type> train_data = {{0.05f, 0.10f}};
	NN::Math::Algebra::Vector_Arithmetic<current_type> test_data = {{0.01f, 0.99f}};
